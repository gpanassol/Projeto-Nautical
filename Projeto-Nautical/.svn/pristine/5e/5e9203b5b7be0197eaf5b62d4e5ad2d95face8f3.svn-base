...
namespace Projeto
{
    public partial class FormCadastraProduto : Form
    {
        ...
        public void limpa()
        {
            ...
            comboBoxListFornecedor.Items.Clear();

            comboBoxListFornecedor.Items.Add("");
            carregarFornecedor();

            buttonCadastrar.Text = "Cadastrar";
            textBoxCodProduto.Enabled = true;
        }
        ...
        private void carregarFornecedor()
        {
            ...
            if (fornecedores.Count > 0)
            {
                for (int i = 0; i < fornecedores.Count; i++)
                {
                    ...
                    comboBoxListFornecedor.Items.Add(fornecedor.RazaoSocial);
                }
            }
        }
